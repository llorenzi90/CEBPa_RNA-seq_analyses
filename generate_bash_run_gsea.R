...
setwd("/home")
system("cp ")
cmm1 <- './gsea-cli.sh GSEAPreranked -gmx ../share/Cuartero\\ Group/CUARTERO\\ GROUP/CBPa/RNA-seq/Mm.h.all.v7.1.entrez.gmt -collapse false -mode Max_probe -norm meandiv -nperm 1000 -rnk ../share/Cuartero\\ Group/CUARTERO\\ GROUP/CBPa/RNA-seq/DESeq2_results_NEW/rank_files/'
...
cmm3 <- " -create_svgs false -include_only_symbols true -make_sets true -plot_top_x 20 -rnd_seed timestamp -set_max 500 -set_min 15 -zip_report false -out ../share/Cuartero\\ Group/CUARTERO\\ GROUP/CBPa/RNA-seq/GSEA_results_NEW"

commands <- c()
#for(f in list.files("/Users/llorenzi/Nextcloud/CBPa_RNA_seq/DESeq2_results/rank_files/")){
for(f in list.files("~/share/Cuartero Group/CUARTERO GROUP/CBPa/RNA-seq/DESeq2_results_NEW/rank_files/")){
...
write(commands,"~/share/Cuartero Group/CUARTERO GROUP/CBPa/RNA-seq/run_GseaPreranked_CBPa_DESeq2.sh")
